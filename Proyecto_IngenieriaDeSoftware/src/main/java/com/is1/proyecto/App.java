...
public class App {
    ...
    public static void main(String[] args) {
        ...
        get("/dashboard", (req, res) -> {
            ...
            // Renderiza la plantilla del dashboard con el nombre de usuario.
        ...
        post("/teacher/new", (req, res) -> {
            ...
            try {
                ...
                Teacher existingTeacher = Teacher.findFirst("dni = ?", dni); //SELECT * FROM teachers WHERE dni = 12345678 LIMIT 1.
                if (existingTeacher != null) {
                    res.redirect("/teacher/new?error=El DNI ingresado ya existe en el sistema.");
                    return "";
                }
                ...
                // Error si el DNI o Teléfono no son números válidos
                res.redirect("/teacher/new?error=El DNI y el Teléfono deben ser números válidos.");
                return "";
            } catch (Exception e) {
                // Error general (ej. fallo de conexión DB)
                e.printStackTrace();
